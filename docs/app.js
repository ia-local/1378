...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function buildDynamicUI(timeline) {
        ...
        timeline.forEach((item, index) => {
            ...
            const filesHtml = item.files.map(file => `<li><a class="fr-link fr-link--download" href="https://github.com/ia-local/1378/data/${item.year.substring(0,4)}/${file}" download>${file}</a></li>`).join('');
